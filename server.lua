...
local function CheckVersion()
    ...
    local resourceName = Config.VersionCheck.resourceName or GetCurrentResourceName()
    local currentVersion = Config.VersionCheck.currentVersion or GetResourceMetadata(GetCurrentResourceName(), 'version', 0) or '0.0.0'
    local versionUrl = Config.VersionCheck.githubVersionUrl
